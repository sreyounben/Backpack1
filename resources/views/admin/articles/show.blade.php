...
@section('content')
    <table aria-hidden="true" class="table table-striped">
        <tbody>
            ...
            <tr>
                <td class="border-0 font-weight-bold">Article title</td>
                <td class="border-0 ">:</td>
                <td class="border-0">{{ $entry->title }}</td>

            </tr>
            <tr>
                <td class="border-0 font-weight-bold">Article content</td>
                <td class="border-0 ">:</td>
                <td class="border-0">{{ $entry->content }}</td>
            </tr>
            <tr>
                {{-- <td class="border-0 font-weight-bold">Number</td>
                <td class="border-0 ">:</td>
                <td class="border-0">{{ $entry->number }}</td> --}}
